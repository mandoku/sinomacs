...
;;
;; If you do not have a copy of the GNU General Public License, you can obtain one by writing to the Free Software Foundation, Inc., 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.

;;; Commentary:
;;
;; A quick but useful hack for TEI-P5 XML documents: it provides a function that looks up the name of the element before point and displays the TEI guidelines for that element.
;;
;; You need to download and unzip the HTML documentation from  http://tei.sf.net -- the filename will look something like  tei-p5-doc-0.1.9.zip
;;
;; Now set the variable tei-html-docs-p5-dir to the directory with all of the ref-*.html files you just unzipped, like so:
;;
;;    (setq tei-html-docs-p5-dir "~/TEI_P5/")
;;
;; If you don't set tei-html-docs-p5-dir, then the on-line version of the docs on the TEI web-site will be used instead.
;;
;; Put this package somewhere in your load-path, require it, and assign the function tei-html-docs-p5-element-at-point to a key-binding, with lines like these in your .emacs (this example assumes you use nxml-mode to edit TEI documents):
;;
;;    (require 'tei-html-docs-p5)
;;    (define-key nxml-mode-map (kbd "<f9>") 'tei-html-docs-p5-element-at-point)
